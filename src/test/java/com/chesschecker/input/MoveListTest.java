...
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Kf1");
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Qf1");
//        sut.forEach(boardMove -> {
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Rf1");
//        sut.forEach(boardMove -> {
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Bf1");
//        sut.forEach(boardMove -> {
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Nf1");
//        sut.forEach(boardMove -> {
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Pf1");
//        sut.forEach(boardMove -> {
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("f1");
...
//        final int startRow = 1;
//        final int startCol = 5;
//        HashSet<BoardMove> sut = MoveList.getSudoValidMoves("Zf1");
//        Assert.assertEquals(new HashSet<BoardMove>(), sut);
//    }
//}